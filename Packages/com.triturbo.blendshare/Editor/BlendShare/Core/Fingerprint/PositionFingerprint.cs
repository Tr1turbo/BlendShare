...
{
    /// <summary>
    /// Position and feature-sample signature used to match Unity vertices to FBX control points.
    /// </summary>
    internal sealed class PositionFingerprint
    {
        ...
        /// <summary>
        /// Quantized spatial key used to bucket base vertex positions.
        /// </summary>
        ...
        /// <summary>
        /// Groups identical FBX control-point fingerprints so matching can use representative candidates.
        /// </summary>
        ...
        /// <summary>
        /// Spatial lookup for finding the best matching fingerprint candidate.
        /// </summary>
